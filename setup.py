...
setup(name='docassemble.VTFamilyCourtInfoSheet',
      ...
      install_requires=['docassemble.ALAnyState>=0.1.0', 'docassemble.ALToolbox>=0.10.1', 'docassemble.AssemblyLine>=2.27.1', 'docassemble.VTFeedback', 'docassemble.VTSharedYMLFile'],
      zip_safe=False,
